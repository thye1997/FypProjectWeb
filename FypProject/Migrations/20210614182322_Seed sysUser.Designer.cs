...
namespace FypProject.Migrations
{
    ...
    [Migration("20210614182322_Seed sysUser")]
    partial class SeedsysUser
    {
            ...
            modelBuilder.Entity("FypProject.Models.SystemUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Password = "$2a$11$x0nkuixF8CLzDt8SWnWr8efeMk78nscmmV1rlaudytvQUdTett2XW",
                            Role = "Doctor",
                            createdOn = "15/06/2021 02:23 AM",
                            userName = "Doctor_2"
                        });
                });
